                        ...
                        error:(NSError **)errorPtr
{
  ...
  referenceImagePixelSize = CGSizeMake(referenceImagePixelSize.width * referenceImage.scale, referenceImagePixelSize.height * referenceImage.scale);
  CGSize imagePixelSize = image.size;
  imagePixelSize = CGSizeMake(imagePixelSize.width * image.scale, imagePixelSize.height * image.scale);
                                 ...
                                 identifier:(NSString *)identifier
{
  ...
  NSArray *testComponents = [_testName componentsSeparatedByString:@"."];
  NSString *testNameFormatted = testComponents[1];

  NSString *filePath = [_referenceImagesDirectory stringByAppendingPathComponent:testNameFormatted];
                            ...
                            fileNameType:(FBTestSnapshotFileNameType)fileNameType
{
  ...
  NSArray *testComponents = [_testName componentsSeparatedByString:@"."];
  NSString *testNameFormatted = testComponents[1];
  NSString *filePath = [folderPath stringByAppendingPathComponent:testNameFormatted];
  filePath = [filePath stringByAppendingPathComponent:fileName];
  return filePath;
}
